...
// Reporte Gestion 2: cantidad de visitantes AUTENTICADOS por todos los usuarios
// pero pudiendo establecer una fecha desde hasta separando ingresos de egresos
