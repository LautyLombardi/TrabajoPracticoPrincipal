...
const useInsertImageUserFail = () => {
    const db = useSQLiteContext();

    const insertImageUserFail = useCallback(async (userId: number, admDni: number) => {
    ...
    return insertImageUserFail;
};

export default useInsertImageUserFail;