...
const ReportesHistoricosrrhh: React.FC = () => {
  ...
  const fetchData = async () => {
    ...
    const fechasFiltradas = Object.keys(visitantesPorDia)
      .filter(fecha => {
    ...
    const ingresosArray = fechasFiltradas.map(fecha => visitantesPorDia[fecha].ingresos);
    const egresosArray = fechasFiltradas.map(fecha => visitantesPorDia[fecha].egresos);
