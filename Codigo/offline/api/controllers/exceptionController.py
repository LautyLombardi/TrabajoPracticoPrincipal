...
def validate(data):
    ...
    if data.get('category_id') is None or data.get('place_id') is None or data.get('name') is None or data.get('description') is None or data.get('duration') is None  or data.get('adm_dni') is None:
    ...
    if not isinstance(category_id, int) or not isinstance(place_id, int) or not isinstance(adm_dni, int) :
